...
if( !class_exists( 'YITH_WooCommerce_Product_Slider' ) ) {
    ...
    class YITH_WooCommerce_Product_Slider
    {
        ...
        public function action_links($links)
        {
            ...
            $premium_live_text = defined( 'YWCPS_FREE_INIT' ) ?  __( 'Premium live demo', 'ywcps' ) : __( 'Live demo', 'ywcps' );
        ...
        public function ywcps_media_buttons_context( $context ) {
            ...
            $out = '<a id="ywcps_shortcode" style="display:none" href="#" class="hide-if-no-js" title="' . __( 'Add YITH WooCommerce Product Slider Carousel shortcode', 'ywcps' ) . '"></a>';
        ...
        public function ywcps_add_quicktags() {
            ...
            $lightbox_url = esc_url( add_query_arg( $query_args, YWCPS_URL . '/templates/admin/lightbox.php' ) );
            ...
            <script type="text/javascript">
                ...
                jQuery('#ywcps_shortcode').on( 'click', function () {

                    tb_show('Add YITH WooCommerce Product Slider Carousel shortcode', '<?php echo $lightbox_url ?>');

                    ywcps_resize_thickbox(450,500);
